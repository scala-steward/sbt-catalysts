...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "fs2" ,             version = "3.8.0",  org = "co.fs2", modules = "fs2-core")
    .addJVM(name = "fs2-jvm" ,      version = "3.8.0",  org = "co.fs2", "fs2-reactive-streams", "fs2-io")
    ...
    .add(name = "specs2",           version = "4.20.1",  org = "org.specs2", "specs2-core", "specs2-scalacheck", "specs2-mock")
