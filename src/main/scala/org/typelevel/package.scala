...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "cats-effect",      version = "3.4.10", org = typeLevelOrg, "cats-effect", "cats-effect-laws")
    ...
    .addJVM(name = "fs2-kafka",     version = "3.0.0",  org = "com.github.fd4s")
    ...
    .addJVM( name = "pureconfig",      version = "0.17.3", org = "com.github.pureconfig", "pureconfig-cats-effect", "pureconfig-generic")
